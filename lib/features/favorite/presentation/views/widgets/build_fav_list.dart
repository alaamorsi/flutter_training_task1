...
import 'package:flutter_training_task1/features/property/presentation/views/property_details_screen.dart';
import 'package:get/get.dart';

class BuildFavList extends StatelessWidget {
  final FavModel model;
  final int index;
  final PropertyController controllerProperty = Get.put(PropertyController());

  BuildFavList({super.key, required this.model, required this.index});
  ...
  Widget build(BuildContext context) {
    return GetX<FavController>(
      builder: (controller) => InkWell(
        onTap: () {
           controllerProperty.fetchProperty(model.id);
